...
const RegisteredStatisticianPage: React.FC = () => {
    return (
        <main className="relative overflow-hidden bg-white dark:bg-gray-950">
            ...
            <section className="relative isolate px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
                ...
                >
                    ...
                    >
                        Become a Recognized Statistician
                    </motion.h1>
                    ...
                    >
                        <p>
                            This is the basic entry point for CISON membership and it is open
...
export default RegisteredStatisticianPage;
